...
class getChatter_TransportsService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['chatter.transports'] = (new \Symfony\Component\Notifier\Transport(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['notifier.transport_factory.telegram'] ?? $container->load('getNotifier_TransportFactory_TelegramService'));
            yield 1 => ($container->privates['notifier.transport_factory.null'] ?? $container->load('getNotifier_TransportFactory_NullService'));
        }, 2)))->fromStrings(['telegram' => $container->getEnv('TELEGRAM_DSN')]);
    }
}
