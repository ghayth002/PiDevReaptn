...
class getNotificationControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = ($container->privates['App\\Service\\MockWeatherService'] ??= new \App\Service\MockWeatherService());

        $container->services['App\\Controller\\NotificationController'] = $instance = new \App\Controller\NotificationController(new \App\Service\NotificationService($a, new \Symfony\Component\Notifier\Chatter(($container->privates['chatter.transports'] ?? $container->load('getChatter_TransportsService')), ($container->services['messenger.default_bus'] ?? self::getMessenger_DefaultBusService($container)), ($container->services['event_dispatcher'] ?? self::getEventDispatcherService($container))), $b), $b);
