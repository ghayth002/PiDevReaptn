...
class getProductTypeRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProductTypeRepository.php';

        return $container->privates['App\\Repository\\ProductTypeRepository'] = new \App\Repository\ProductTypeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
