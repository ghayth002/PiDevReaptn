...
class getNotifier_Channel_EmailService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['notifier.channel.email'] = new \Symfony\Component\Notifier\Channel\EmailChannel(NULL, ($container->services['messenger.default_bus'] ?? self::getMessenger_DefaultBusService($container)), 'noreply@reaptn.com');
    }
}
