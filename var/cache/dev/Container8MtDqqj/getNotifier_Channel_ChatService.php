...
class getNotifier_Channel_ChatService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['notifier.channel.chat'] = new \Symfony\Component\Notifier\Channel\ChatChannel(NULL, ($container->services['messenger.default_bus'] ?? self::getMessenger_DefaultBusService($container)));
    }
}
